        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
            A Student of Electrical and Computer Engineering with a strong passion for Front-End development. I focus on creating engaging digital experiences and consistently strive to deliver the best solutions in every project I work on.
            </p>
